...
const ProductList = () => {
    const { products, currency } = useAppContext(); // ✅ Fix: added ()

    return (
        <div className="no-scrollar flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
            {/* ✅ Fixed: overflow-y-scroll typo */}
